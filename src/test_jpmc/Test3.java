...
public class Test3 {
    public static void main(String[] args) {
        ...
        Map<String, List<Employee>> top3EmployeePerDepartment =
                employees.stream().collect(
                        Collectors.groupingBy(
                                // get the departments
                                employee -> employee.getDepartment().getDeptName(),
                                // get the top 3 employees based upon salary for each department
        ...
        top3EmployeePerDepartment.forEach((department, employee) -> {
